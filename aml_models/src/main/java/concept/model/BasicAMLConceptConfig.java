...
public class BasicAMLConceptConfig implements IAMLConceptConfig{
	...
	public boolean equals(Object obj) {
	    ...
	    return this.identifiedById == ((BasicAMLConceptConfig) obj).identifiedById
	    		&& this.distinguished == ((BasicAMLConceptConfig) obj).distinguished
...
//	    		&& this.primary == ((BasicAMLConceptConfig) other).primary
	...
	public AttributeType toCAEXAttribute() {
		...
		amlConf.setName(BasicAMLConceptConfig.CONFIG);		
		amlConf.getAttribute().add(toCAEXAttribute(BasicAMLConceptConfig.CONFIG_DISTINGUISHED, distinguished));
		amlConf.getAttribute().add(toCAEXAttribute(BasicAMLConceptConfig.CONFIG_MIN, minCardinality));
		amlConf.getAttribute().add(toCAEXAttribute(BasicAMLConceptConfig.CONFIG_MAX, maxCardinality));
		amlConf.getAttribute().add(toCAEXAttribute(BasicAMLConceptConfig.CONFIG_ID, identifiedById));
		amlConf.getAttribute().add(toCAEXAttribute(BasicAMLConceptConfig.CONFIG_NAME, identifiedByName));				
		return amlConf;
	}
	...
	public void fromCAEXAttribute(AttributeType attr) {
		...
		for(AttributeType child : attr.getAttribute()) {
			if(child.getName().equalsIgnoreCase(BasicAMLConceptConfig.CONFIG_DISTINGUISHED)) {
