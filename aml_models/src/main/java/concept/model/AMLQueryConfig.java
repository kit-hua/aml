...
public class AMLQueryConfig extends BasicAMLConceptConfig{
	...
	public void fromAMLConceptConfig(AMLConceptConfig acc) {
		this.setIdentifiedById(acc.isIdentifiedById());
		this.setIdentifiedByName(acc.isIdentifiedByName());
		this.setDistinguished(acc.isDistinguished());
		this.setDescendant(acc.isDescendant());
		this.setMaxCardinality(acc.getMaxCardinality());
		this.setMinCardinality(acc.getMinCardinality());
