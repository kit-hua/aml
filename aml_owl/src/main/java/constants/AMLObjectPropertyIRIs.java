...
public final class AMLObjectPropertyIRIs {
	...
	/**
	 * essential object properties: currently used in learning
	 */
	public static final IRI HAS_EI = IRI.create(Consts.aml_pref + "hasEI");
	
	public static final IRI IS_EI_OF = IRI.create(Consts.aml_pref + "isEIOf");
	
//	public static final IRI HAS_EI_TC = IRI.create(Consts.aml_pref + "hasEI+");
	public static final IRI HAS_EI_TC = IRI.create(Consts.aml_pref + "hasEIDescendant");
	
//	public static final IRI IS_EI_OF_TC = IRI.create(Consts.aml_pref + "isEIOf+");
	public static final IRI IS_EI_OF_TC = IRI.create(Consts.aml_pref + "isEIOfDescendant");
	
	public static final IRI HAS_IE = IRI.create(Consts.aml_pref + "hasIE");
	
	public static final IRI IS_IE_OF = IRI.create(Consts.aml_pref + "isIEOf");
	
//	public static final IRI HAS_IE_TC = IRI.create(Consts.aml_pref + "hasIE+");
	public static final IRI HAS_IE_TC = IRI.create(Consts.aml_pref + "hasIEDescendant");
	
//	public static final IRI IS_IE_OF_TC = IRI.create(Consts.aml_pref + "isIEOf+");
	public static final IRI IS_IE_OF_TC = IRI.create(Consts.aml_pref + "isIEOfDescendant");
	
	public static final IRI HAS_IL = IRI.create(Consts.aml_pref + "hasIL");
	
	public static final IRI HAS_IE_SIBLING = IRI.create(Consts.aml_pref + "hasIESibling");
	
	public static final IRI HAS_EI_SIBLING = IRI.create(Consts.aml_pref + "hasEISibling");
	
	public static final IRI IS_IE_SIBLING_OF_IE = IRI.create(Consts.aml_pref + "isIESiblingOfIE");
	
	public static final IRI IS_IE_SIBLING_OF_EI = IRI.create(Consts.aml_pref + "isIESiblingOfEI");
	
	public static final IRI IS_EI_SIBLING_OF_IE = IRI.create(Consts.aml_pref + "isEISiblingOfIE");
	
	public static final IRI IS_EI_SIBLING_OF_EI = IRI.create(Consts.aml_pref + "isEISiblingOfEI");
